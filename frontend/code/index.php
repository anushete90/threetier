...
echo "<h1> Anuja Shete Testing</h1>";
echo "<h3> Your Web Running Apache with php on Frontend container </h3>";
echo "<h3> Your APP Running Apache and PHP 

providing API services for User information on url http://backend/get_user_details </h2>";
echo "<h3> Your Database running 

Mysql/Mariadb holding user information in userdb on users Table </h1>";
